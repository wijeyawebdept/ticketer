            ...
            try {
                List<TicketCategory> ticketCategories = request.getTicketCategories().stream()
                        .map(ticketCategoryRequest -> TicketCategory.builder()
                                ...
                                .salesStartDate(ticketCategoryRequest.getSalesStartDate())
                                .salesEndDate(ticketCategoryRequest.getSalesEndDate())
                                .earlyBirdPrice(ticketCategoryRequest.getEarlyBirdPrice())
                                .earlyBirdCapacity(ticketCategoryRequest.getEarlyBirdCapacity())
        ...
        if (event.getTicketCategories() != null) {
            ticketCategoryResponses = event.getTicketCategories().stream()
                    .map(ticketCategory -> TicketCategoryResponse.builder()
                            ...
                            .salesStartDate(ticketCategory.getSalesStartDate())
                            .salesEndDate(ticketCategory.getSalesEndDate())
                            .earlyBirdPrice(ticketCategory.getEarlyBirdPrice())
                            .earlyBirdCapacity(ticketCategory.getEarlyBirdCapacity())
