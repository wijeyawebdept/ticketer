...
export interface RecycleBinItem {
  recycleId: string;
  entityType: 'USER' | 'ADMIN' | 'ORGANIZER' | 'ORGANIZER_EMPLOYEE' | 'EVENT' | 'VENUE' | 'SCHEDULE' | 'EVENT_CATEGORY' | 'BLOG';
  entityId: string;
  entityName: string;
  entityData: any;
  deletedBy: string;
...
class RecycleBinService {
   ...
   */
  async getRecycleBinItemsByType(entityType: 'USER' | 'ADMIN' | 'ORGANIZER' | 'ORGANIZER_EMPLOYEE' | 'EVENT' | 'VENUE' | 'SCHEDULE' | 'EVENT_CATEGORY' | 'BLOG'): Promise<RecycleBinItem[]> {
    const basePath = this.getBasePath();
   ...
   */
  async emptyRecycleBinByType(entityType: 'USER' | 'ADMIN' | 'ORGANIZER' | 'ORGANIZER_EMPLOYEE' | 'EVENT' | 'VENUE' | 'SCHEDULE' | 'EVENT_CATEGORY' | 'BLOG'): Promise<void> {
    const basePath = this.getBasePath();
