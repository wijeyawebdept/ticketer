...
const TermsAndConditionsManager: React.FC = () => {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      await PageContentService.updatePageContent('TERMS_AND_CONDITIONS', formData.title, formData.content);
      setSnackbar({ open: true, message: 'Terms and Conditions updated successfully', severity: 'success' });
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box sx={{ mb: 3 }}>
        <h1>Terms and Conditions Manager</h1>
        <Typography color="textSecondary">Manage and edit the Terms and Conditions content</Typography>
      </Box>
