...
const PrivacyPolicyManager: React.FC = () => {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      await PageContentService.updatePageContent('PRIVACY_POLICY', formData.title, formData.content);
      setSnackbar({ open: true, message: 'Privacy Policy updated successfully', severity: 'success' });
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box sx={{ mb: 3 }}>
        <h1>Privacy Policy Manager</h1>
        <Typography color="textSecondary">Manage and edit the Privacy Policy content</Typography>
      </Box>
