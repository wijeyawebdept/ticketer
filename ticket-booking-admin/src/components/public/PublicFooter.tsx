        ...
        <Container maxWidth="lg">
          <Grid container spacing={4}>
            ...
            <Grid item xs={6} md={2}>
              ...
              <Link href="#" display="block" color="inherit" sx={{ mb: 1, textDecoration: 'none', fontFamily: 'Raleway, sans-serif', '&:hover': { color: '#fff' } }}>Events</Link>
              <Link href="#" display="block" color="inherit" sx={{ mb: 1, textDecoration: 'none', fontFamily: 'Raleway, sans-serif', '&:hover': { color: '#fff' } }}>Ticketer Deals</Link>
